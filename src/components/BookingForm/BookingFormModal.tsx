...
const BookingFormModal = () => {
  ...
  return (
    <div className="flex flex-col justify-start items-center mx-auto py-6 bg-black/30 rounded-lg min-h-full w-full">
      <form
        onSubmit={handleSubmit}
        className="w-3/5 flex justify-center items-center gap-6 flex-col sm:flex-row"
      >
        <Image
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="flex gap-6 w-full flex-col-reverse md:flex-row items-center">
            <div className="flex flex-col w-fit">
              ...
              <select className="w-full sm:w-fit rounded-xl h-11 bg-gray-200 text-black/80 shadow-2xl border-gray-600  placeholder:font-bold font-bold text-xs md:text-sm xl:text-lg text-center">
                {[...Array(10)].map((_, i) => (
